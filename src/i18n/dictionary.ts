...
const it = {
  ...
  app: {
    ...
    settings: {
      ...
      anonymousTitle: "Anonimo",
      publicNameDesc: "Il tuo nome completo sarà visibile in classifica",
      anonymousDesc: "In classifica saranno visibili solo 3 lettere",
...
const en: typeof it = {
  ...
  app: {
    ...
    settings: {
      ...
      publicNameDesc: "Your full name will show on the leaderboard",
      anonymousDesc: "Only 3 letters will show on the leaderboard",
