...
const en: typeof it = {
  ...
  app: {
    ...
    paywall: {
      appName: "YEARS",
      planType: "Premium",
      title: "Unlock your full freedom",
      feature1: "Unlimited projections and AI scenarios",
      feature2: "Time cost of every purchase",
      feature3: "Live portfolio risks and prices",
      feature4: "Life goals and world leaderboard",
      monthly: "Monthly",
      yearly: "Yearly",
      lifetime: "Lifetime",
      badgeYearly: "SAVE 19%",
      badgeLifetime: "PAY ONCE",
      subscribe: "Continue",
