    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-sm bg-card border border-border rounded-2xl p-6 shadow-2xl animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-background border border-border rounded-xl py-3 text-sm font-light text-foreground hover:bg-muted/50 transition-colors mb-4"
        >
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center">
            <span className="bg-card px-3 text-[10px] uppercase tracking-wider text-muted-foreground">or</span>
          </div>
        </div>
