...
const Hero = () => {
  ...
  return (
    <section id="top" className="relative min-h-[90svh] w-full overflow-hidden bg-black text-foreground md:min-h-[100svh]">
      ...
      {/* Content container */}
      <div className="relative z-10 mx-auto flex min-h-[90svh] max-w-7xl flex-col px-4 pt-16 md:min-h-[100svh] md:px-8 md:pt-28">
        {/* Hero section */}
